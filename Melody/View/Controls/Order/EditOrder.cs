...
namespace Melody.View.Controls
{
  public partial class EditOrder : UserControl
  {
    ...
    private void EditOrder_panel_Paint(object sender, PaintEventArgs e)
    {
      EditOrder_panel.Location = new Point(
      this.ClientSize.Width / 2 - EditOrder_panel.Size.Width / 2);
      EditOrder_panel.Anchor = AnchorStyles.None;
    }

    private void UpdateOrder_btn_Click(object sender, EventArgs e)
    {
      OrderCollect();
      ...
      foreach (var item in orders)
      {
        ...
        {
          ClearErrorLabel();
          Id_tb.Text = _orderRepository.CheckLast().ToString();

          if (validationResult.IsValid)
          {
            _orderRepository.UpdateOrder(item);
    ...
    {
      Id_tb.Text = orderNumber.ToString();

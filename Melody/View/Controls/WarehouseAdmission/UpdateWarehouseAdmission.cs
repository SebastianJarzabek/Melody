...
{
  public partial class UpdateWarehouseAdmission : UserControl
  {
    ...
    public UpdateWarehouseAdmission(IMaterialReceiptRepository materialReceiptRepository)
    {
    ...
    private void UpdateWarehouseAdmission_btn_Click(object sender, EventArgs e)
    {
      AdmissionCollect();
      ...
      foreach (var item in warehouseAdmission)
      {
        ...
        try
        {
          ...
          {
            _materialReceiptRepository.UpdateWarehouseAdmission(item);
            MessageBox.Show($"Edytowano przyjęcie o numerze: {warehouseAdmissionNumber}.",
                            "Informacja",
        ...
        {
          Validation_lbl.Text = validationResult.ErrorMessageToDisplay;
          MessageBox.Show($"Wystąpił błąd przy dodaniu przyjęcia o numerze: {warehouseAdmissionNumber} do bazy. {ex}",
                          "Błąd",
                          MessageBoxButtons.OK,
                          MessageBoxIcon.Error);
          throw ex;
    ...
    private void UpdateWarehouseAdmission_Load(object sender, EventArgs e)
    {
      warehouseAdmissionNumber_tb.Text = warehouseAdmissionNumber.ToString();
    ...
    private void UpdateWarehouseAdmission_panel_Paint(object sender, PaintEventArgs e)
    {
      UpdateWarehouseAdmission_panel.Location = new Point(
      this.ClientSize.Width / 2 - UpdateWarehouseAdmission_panel.Size.Width / 2
      );
      UpdateWarehouseAdmission_panel.Anchor = AnchorStyles.None;
    }
    ...
    private void AddMaterialToList_btn_Click(object sender, EventArgs e)
    {
      try
      {
        ...
        MaterialsToAdmission_dgv.Rows.Add(materialToOrder.material.Name, materialToOrder.material.Type, materialToOrder.unit.Name, materialToOrder.Quantity);
      }
      catch (Exception ex)
      {
        throw ex;
    ...
    private List<WarehouseAdmission> AdmissionCollect()
    {
    ...
    {
      MaterialsToAdmission_dgv.DataSource = materialToOrders;
      MaterialsToAdmission_dgv.Refresh();
    }
